<template>
  <div>
    <el-row class="img">
      <el-col :span="16">
        <img class="main-pic" :src="this.img[this.picture]" alt />
      </el-col>
      <el-col :span="8">
        <el-row class="pic-list">
          <el-col :span="12" class="pic-even" v-for="(item, index) in img" :key="index">
            <img :src="item" alt @click="Hotelimage(index)" />
          </el-col>
        </el-row>
      </el-col>
    </el-row>
